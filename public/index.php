...
<body>
    <header class="header">
        ...
        <a href="index.php">
            <img src="../img/AceLogo.png" alt="Ace logo" class="header-logo" />
        </a>
        <nav class="main-nav">
    ...
    <main class="margin-top-lg">
        <section class="red-circles container flex flex-gap-lg wrapped margin-bottom-lg">
            <div class="flex flex-column flex-gap-tiny"><label class="red-label"><button class="red-circle-button"><i
            ...
            <div class="flex flex-column flex-gap-tiny"><label class="red-label"><button class="red-circle-button"><i
                            class="fa-solid fa-shoe-prints"></i></button>
                    <p>Shoes</p>
                </label></div>
            <div class="flex flex-column flex-gap-tiny"><label class="red-label"><button class="red-circle-button"><i
                            class="fa-solid fa-laptop"></i></button>
                    <p>Laptops</p>
                </label></div>
        ...
        <section class="filter-section hidden margin-bottom-md">
            <div class="container">
                ...
                <form method="post" class="flex flex-gap-tiny margin-bottom-md" style="display: contents"
                    action="../includes/fetch_listings.php" id="car-search">
                    ...
                    <input type="text" name="cars_search" class="general-text--input searchInput" placeholder="Search"
                        style="width: 96%; margin-left: 1.6rem; margin-bottom: 4.8rem">
                </form>
        ...
        <section class="filter-section hidden margin-bottom-md">
            <div class="container">
                <form method="post" class="flex flex-gap-tiny margin-bottom-md" style="display: contents"
                    action="../includes/fetch_listings.php" id="house-search">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                        class="w-6 h-6 search-icon">
                        <path fill-rule="evenodd"
                            d="M10.5 3.75a6.75 6.75 0 1 0 0 13.5 6.75 6.75 0 0 0 0-13.5ZM2.25 10.5a8.25 8.25 0 1 1 14.59 5.28l4.69 4.69a.75.75 0 1 1-1.06 1.06l-4.69-4.69A8.25 8.25 0 0 1 2.25 10.5Z"
                    ...
                    <input type="text" name="housings_search" class="general-text--input searchInput"
                        placeholder="Search" style="width: 96%; margin-left: 1.6rem; margin-bottom: 4.8rem">
                </form>
                <form method="post" style="padding: 0" action="../includes/fetch_listings.php" id="house-filter">
                    <div class="grid grid--2-cols filter-mobile">
                        ...
                        <div class="margin-bottom-md">
                            ...
                            <div class="flex flex-gap-sm">
                                <input type="text" class="general-text--input" name="square_meters_from"
                                    placeholder="from">
        ...
        <section class="filter-section hidden margin-bottom-md">
            <div class="container">
                <form method="post" class="flex flex-gap-tiny margin-bottom-md" style="display: contents"
                    action="../includes/fetch_listings.php" id="phone-search">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                        class="w-6 h-6 search-icon">
                        <path fill-rule="evenodd"
                            d="M10.5 3.75a6.75 6.75 0 1 0 0 13.5 6.75 6.75 0 0 0 0-13.5ZM2.25 10.5a8.25 8.25 0 1 1 14.59 5.28l4.69 4.69a.75.75 0 1 1-1.06 1.06l-4.69-4.69A8.25 8.25 0 0 1 2.25 10.5Z"
                    ...
                    <input type="text" name="phones_search" class="general-text--input searchInput" placeholder="Search"
                        style="width: 96%; margin-left: 1.6rem; margin-bottom: 4.8rem">
                </form>
                <form method="post" style="padding: 0" action="../includes/fetch_listings.php" id="phone-filter">
                    <div class="grid grid--2-cols filter-mobile">
                        ...
                        <div class="margin-bottom-lg">
                            <p class="margin-bottom-sm">Price range:</p>
                            <div class="flex flex-gap-sm">
                                <input type="text" class="general-text--input" name="phone_price_min"
                                    placeholder="from">
        ...
        <section class="filter-section hidden margin-bottom-md">
            ...
            <div class="container">
                <form class="flex flex-gap-tiny margin-bottom-md" style="display: contents"
                    action="../includes/fetch_listings.php" id="shoe-search">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                        class="w-6 h-6 search-icon">
                        <path fill-rule="evenodd"
                            d="M10.5 3.75a6.75 6.75 0 1 0 0 13.5 6.75 6.75 0 0 0 0-13.5ZM2.25 10.5a8.25 8.25 0 1 1 14.59 5.28l4.69 4.69a.75.75 0 1 1-1.06 1.06l-4.69-4.69A8.25 8.25 0 0 1 2.25 10.5Z"
                    ...
                    <input type="text" name="shoes_search" class="general-text--input searchInput" placeholder="Search"
                        style="width: 96%; margin-left: 1.6rem; margin-bottom: 4.8rem">
                </form>
        ...
        <section class="filter-section hidden margin-bottom-md">
            <div class="container">
                <form class="flex flex-gap-tiny margin-bottom-md" style="display: contents"
                    action="../includes/fetch_listings.php" id="laptop-search">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                        class="w-6 h-6 search-icon">
                        <path fill-rule="evenodd"
                            d="M10.5 3.75a6.75 6.75 0 1 0 0 13.5 6.75 6.75 0 0 0 0-13.5ZM2.25 10.5a8.25 8.25 0 1 1 14.59 5.28l4.69 4.69a.75.75 0 1 1-1.06 1.06l-4.69-4.69A8.25 8.25 0 0 1 2.25 10.5Z"
                    ...
                    <input type="text" name="laptops_search" class="general-text--input searchInput"
                        placeholder="Search" style="width: 96%; margin-left: 1.6rem; margin-bottom: 4.8rem">
                </form>
        ...
        <div class="container-main grid grid--2-cols" id="search-and-filters-button">
            <form method="post" class="flex flex-gap-tiny" style="padding: 0" action="../includes/fetch_listings.php"
                id="search">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                    class="w-6 h-6 search-icon">
                    <path fill-rule="evenodd"
        ...
        <div class="pop-up hidden">
            ...
            <form action="../includes/fetch_listings.php" method="post" style="padding: 0;" id="small-filter">
                <section class="red-circles container flex flex-gap-tiny wrapped" style="margin-bottom: 20px">
                    <div class="flex flex-column flex-gap-tiny"><label class="red-label"><button
                                class="red-circle-button1" name="subcategory" value="car" type="submit"><i
                                    class="fa-solid fa-car"></i></button></label></div>
                    <div class="flex flex-column flex-gap-tiny"><label class="red-label"><button
                                class="red-circle-button1" name="subcategory" value="house" type="submit"><i
                                    class="fa-solid fa-house"></i></button></label></div>
                    <div class="flex flex-column flex-gap-tiny"><label class="red-label"><button
                                class="red-circle-button1" name="subcategory" value="mobile" type="submit"><i
                                    class="fa-solid fa-mobile-screen-button"></i></button></label></div>
                    <div class="flex flex-column flex-gap-tiny"><label class="red-label"><button
                                class="red-circle-button1" name="subcategory" value="shoe" type="submit"><i
                                    class="fa-solid fa-shoe-prints"></i></button></label></div>
                    <div class="flex flex-column flex-gap-tiny"><label class="red-label"><button
                                class="red-circle-button1" name="subcategory" value="laptop" type="submit"><i
                                    class="fa-solid fa-laptop"></i></button></label></div>
                </section>
            </form>
