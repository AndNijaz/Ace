    ...
    <section class="listing-section">
            ...
            <section class="comment-section margin-top-md hidden">
                ...
                <?php foreach ($comments as $comment): ?>
                    <?php if ($comment['Parent_Comment'] == null): ?>
                        ...
                        <div class="margin-bottom-xsm child-comment reply-comment hidden"
                            id="reply-comment-<?php echo $comment['C_ID']; ?>">
                            <?php if (isset($_SESSION['U_ID'])) { ?>
        ...
        <?php if (isset($_SESSION['U_ID']) && $row_listing["Seller"] != $_SESSION['U_ID']) { ?>
            <div class="pop-up transaction-pop-up hidden">
                ...
                <div class="payment-section">
                    <form class="form-payment hidden" id="credit-card-form" action="../includes/transaction-processing.php"
                        method="POST">
                        ...
                        <div>
                            ...
                            <div class="quantity-container">
                                <button type="button" class="quantity-btn decrement" data-action="minus"
                                    data-form="credit-card-form">-</button>
                                <input type="number" class="quantity-input" id="quantity-credit-card" name="quantity"
                                    value="1" min="1" max="<?php echo $row_listing["Quantity"]; ?>" readonly>
                                <button type="button" class="quantity-btn increment" data-action="add"
                                    data-form="credit-card-form">+</button>
                            </div>
                        </div>

                        <div class="flex flex-column">
                            <p class="heading-tertiary--black container-button-left margin-bottom-sm total-price"
                                id="total-price-credit-card"><?php echo $row_listing['Price'] . "KM"; ?></p>
                    ...
                    <form class="form-payment hidden" id="paypal-form" action="../includes/transaction-processing.php"
                        method="POST">
                        <div>
                        ...
                        <div>
                            ...
                            <div class="quantity-container">
                                <button type="button" class="quantity-btn decrement" data-action="minus"
                                    data-form="paypal-form">-</button>
                                <input type="number" class="quantity-input" id="quantity-paypal" name="quantity" value="1"
                                    min="1" max="<?php echo $row_listing["Quantity"]; ?>" readonly>
                                <button type="button" class="quantity-btn increment" data-action="add"
                                    data-form="paypal-form">+</button>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-column">
                            <p class="heading-tertiary--black container-button-left margin-bottom-sm total-price"
                                id="total-price-paypal"><?php echo $row_listing['Price'] . "KM"; ?></p>
                            <input type="hidden" value='<?php echo $item_id; ?>' name="item_id" />
