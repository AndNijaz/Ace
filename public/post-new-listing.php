            ...
            <form action="../includes/post-new-listing-processing.php" method="POST">
                ...
                <div class="grid grid--2-cols">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0.05" class="general-text--input margin-bottom-xsm"
                            required name="price">
                    </div>
                </div>
                <div class="grid grid--3-cols">
                    ...
                    <div>
                        ...
                        <input type="number" step="1" min="1" class="general-text--input margin-bottom-xsm" required
                            name="quantity">
                    </div>
                </div>
                ...
                <div class="item-inputs hidden">
                    <div class="grid grid--2-cols">
                        ...
                        <div>
                            ...
                            <input type="number" step="1" class="general-text--input margin-bottom-xsm" name="mileage"
                                value="">
                        </div>
                        <div>
                ...
                <div class="item-inputs hidden">
                    <div class="grid grid--2-cols">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.1" class="general-text--input margin-bottom-xsm"
                                name="square_meters">
                        </div>
                        <div>
                            <p class="margin-bottom-sm">Bedrooms:</p>
                            <input type="number" step="1" class="general-text--input margin-bottom-xsm"
